...
This section describes how we plan to evaluate our work, and how well it performed
...
First, improvements enabled by the service must objectively improve user experience, and do so better than other techniques.
...
value of the LRT system. In the future, the best vote of confidence in the technique would be developer adoption.

Third, we must show that the LRT instrumentation does not unreasonably impact the device's performance.
...
\subsection{Setup}
For ease of implementation, we will develop LRT for Android. We will use a Samsung Galaxy S3
